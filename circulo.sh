function circulo(){
    ...
    SEMICIRCUNFERENCIA=$(awk "BEGIN { printf(\"%.2f\", $CIRCUNFERENCIA / 2) }")

    echo "SEMICIRCUNFERENCIA: $SEMICIRCUNFERENCIA"

    ARCOS_DO_MESMO_TAMANHO_4=$(awk "BEGIN { printf(\"%.2f\", $CIRCUNFERENCIA / 4) }")

    echo "4 ARCOS DO MESMO TAMANHO: $ARCOS_DO_MESMO_TAMANHO_4"
